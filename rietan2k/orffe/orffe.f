...
C**********************************************************************C
      ...
      COMMON /VALI/NG,IPM,NP,IAM,NS,NV,JXP,JX,JBP,JB,NM,ITF,NQ,
     $  INSAVE,NA,LNZ,KK,KKD,IH,NSP,IN,IS,KI1,KI2
      COMMON /VALR/SCALE,DMAX,F,FX,SAVEA,SAVEP,VARA,VARP,E1,E,
     $  PM,DP,DFDP,AM,DA,DFDA,TS,A,AA,BB,P,ROW
C     COMMON  NG,IPM,NP,IAM,NS,NV,JXP,JX,JBP,JB,NM,SCALE,ITF,NQ,
C    &INSAVE,DMAX,NA,F,FX,LNZ,KK,KKD,SAVEA,SAVEP,VARA,VARP,E1,E,IH,NSP,
C    &PM,DP,DFDP,AM,DA,DFDA,IN,TS,IS,A,AA,BB,P,ROW,KI1,KI2
...
*     So as not to change the current directory by opening file #3
      CALL INITIAL
